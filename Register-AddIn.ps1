...
if (-not (Test-Path $assemblyPath)) {
    Write-Error "Assembly not found at '$assemblyPath'. Build the project first:`n  dotnet build ScheduleSync.AddIn\ScheduleSync.AddIn.csproj"
    return
}
...
Write-Host "`nRegistration complete. Restart Microsoft Project to load ScheduleSync." -ForegroundColor Green
