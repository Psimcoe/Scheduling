...
const LevelingDialog: React.FC = () => {
  ...
  }, [projectId, clearExisting, showSnackbar, closeDialog]);
  ...
  }, [projectId, showSnackbar, closeDialog]);
  ...
  return (
    <Dialog open={open} onClose={closeDialog} maxWidth="sm" fullWidth>
      ...
      <DialogActions>
        <Button onClick={handleClearLeveling} color="warning">Clear Leveling</Button>
        <Box sx={{ flex: 1 }} />
        <Button onClick={closeDialog}>Cancel</Button>
        <Button variant="contained" onClick={handleLevel}>Level All</Button>
      </DialogActions>
    </Dialog>
  );
};
