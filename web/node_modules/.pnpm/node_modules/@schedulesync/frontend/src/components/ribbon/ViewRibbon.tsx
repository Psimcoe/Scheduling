  ...
  return (
    <Box sx={{ display: 'flex', alignItems: 'stretch' }}>
      ...
      <RibbonGroup label="Tracking">
        <Tooltip title="Tracking Gantt">
          <IconButton
            size="small"
            onClick={() => setActiveView('trackingGantt')}
            color={activeView === 'trackingGantt' ? 'primary' : 'default'}
          >
            <AssessmentIcon fontSize="small" />
          </IconButton>
        </Tooltip>
        <Tooltip title="Reports Dashboard">
          <IconButton
            size="small"
            onClick={() => setActiveView('reporting')}
            color={activeView === 'reporting' ? 'primary' : 'default'}
          >
            <AssessmentIcon fontSize="small" />
          </IconButton>
        </Tooltip>
