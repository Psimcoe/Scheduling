...
export const useAiStore = create<AiState>((set, get) => ({
  ...
  config: {
    ...
    temperature: 0.7,
    maxTokens: 2048,
    systemPrompt: 'You are a project management assistant. Help users plan, schedule, and manage their projects effectively.',
  },
