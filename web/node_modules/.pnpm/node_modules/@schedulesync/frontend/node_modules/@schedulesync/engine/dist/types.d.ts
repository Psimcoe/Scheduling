...
/** Cost accrual method. */
export declare enum AccrueAt {
    Start = "start",
    End = "end",
    Prorated = "prorated"
}
/** Work contour profile for resource assignments. */
export declare enum WorkContour {
    Flat = "flat",
...
export declare enum ScheduleFrom {
    Start = "start",
    Finish = "finish"
}
/**
...
export declare enum TaskApplyStatus {
    Applied = "applied",
    Skipped = "skipped",
    Failed = "failed",
...
export declare const DEFAULT_APPLY_OPTIONS: ApplyOptions;
...
export declare function createParseResult(updates: TaskUpdate[], errors: ParseError[]): ParseResult;
...
export interface IProjectStore {
    ...
    createTask(update: TaskUpdate, options: ApplyOptions, parentUniqueId?: number | null): TaskSnapshot;
    findOrCreateSummaryTask(name: string, parentUniqueId?: number | null): TaskSnapshot;
    setDeadline(uniqueId: number, deadline: string): void;
    setCustomTextField(uniqueId: number, fieldName: string, value: string): void;
}
/**
...
export type TimephasedType = 'work' | 'actualWork' | 'cost' | 'actualCost' | 'baselineWork' | 'baselineCost';
