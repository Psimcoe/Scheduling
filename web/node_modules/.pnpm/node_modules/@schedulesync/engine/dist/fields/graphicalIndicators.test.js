...
function makeConfig(rules, overrides) {
    return {
        rules,
        showForSummary: true,
        showForProject: true,
...
describe('evaluateIndicator', () => {
    ...
    it('hides from summary when showForSummary=false', () => {
        const config = makeConfig([{ operator: 'gt', values: [0], color: 'green', icon: 'greenCircle' }], { showForSummary: false });
    ...
    it('hides from project summary when showForProject=false', () => {
        const config = makeConfig([{ operator: 'gt', values: [0], color: 'green', icon: 'greenCircle' }], { showForProject: false });
...
//# sourceMappingURL=graphicalIndicators.test.js.map