...
import { recalculate, TaskType, DependencyType, ConstraintType, ScheduleFrom, DEFAULT_CALENDAR, } from '@schedulesync/engine';
import dayjs from 'dayjs';
import utc from 'dayjs/plugin/utc';
dayjs.extend(utc);
function makeProject(tasks, deps = []) {
    return {
        settings: {
            id: 'proj-1',
            name: 'Test',
...
describe('Scheduler', () => {
    ...
    it('cycle detection: should not hang', () => {
        ...
        expect(() => recalculate(project)).toThrow(/cycle/i);
    });
});
