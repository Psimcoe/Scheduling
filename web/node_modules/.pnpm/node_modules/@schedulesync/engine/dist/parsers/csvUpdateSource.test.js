...
describe('CsvUpdateSource', () => {
    ...
    it('parse valid single row returns update', () => {
        const csv = 'UniqueId,NewStart,NewFinish,AllowConstraintOverride,NotesAppend\n' +
    ...
    it('parse all fields', () => {
        const csv = 'UniqueId,ExternalKey,Name,NewStart,NewFinish,NewDurationMinutes,NewPercentComplete,' +
...
//# sourceMappingURL=csvUpdateSource.test.js.map