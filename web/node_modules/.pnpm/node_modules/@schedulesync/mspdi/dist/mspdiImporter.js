...
import { ScheduleFrom, } from '@schedulesync/engine';
import { durationToMinutes, lagFromMspdi } from './durationConverter.js';
import { determineTaskType, mspdiConstraintType, mspdiDayOfWeek, mspdiDependencyType, mspdiResourceType, } from './fieldMapping.js';
 ...
 */
export function importMspdi(xml) {
    ...
    const settings = {
        ...
        scheduleFrom: num(project.ScheduleFromStart, 1) === 1
            ? ScheduleFrom.Start
            : ScheduleFrom.Finish,
...
//# sourceMappingURL=mspdiImporter.js.map