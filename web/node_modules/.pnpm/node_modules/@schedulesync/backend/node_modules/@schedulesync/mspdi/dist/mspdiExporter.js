...
import { constraintTypeToMspdi, dayOfWeekToMspdi, dependencyTypeToMspdi, resourceTypeToMspdi, } from './fieldMapping.js';
 ...
 */
export function exportMspdi(project) {
    const xmlObj = {
...
function buildTasksXml(tasks, dependencies, baselines) {
...
function buildAssignmentXml(asgn) {
    return {
...
//# sourceMappingURL=mspdiExporter.js.map